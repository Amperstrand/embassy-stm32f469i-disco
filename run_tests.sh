#!/bin/bash
# Embassy BSP Test Runner - Flash, capture RTT, parse results
#
# Usage: ./run_tests.sh [test_name|all] [--no-flash]
#   test_name: test_led, test_sdram, test_gpio, test_display, test_touch, test_async_timer, or "all"
...
run_all() {
    ...
    echo "=========================================="
    echo "  Embassy STM32F469I-DISCO BSP Test Runner"
    echo "  $(date)"
    echo "=========================================="
    echo ""
    ...
    {
        echo "Embassy STM32F469I-DISCO BSP Test Report"
        echo "Date: $(date)"
...
if [[ "$TARGET" == "all" ]]; then
    ...
    case "$TARGET" in
        test_led|test_sdram|test_display|test_gpio|test_touch|test_async_timer|test_usb|test_usb_cdc|test_sdram_full|test_sdram_soak|test_uart|test_dma|test_rng|test_adc|hw_diag)
            ...
            [[ "$TARGET" == "test_async_timer" ]] && timeout=30
            ...
            [[ "$TARGET" == "test_usb_cdc" ]] && timeout=120
            [[ "$TARGET" == "hw_diag" ]] && timeout=120
