...
// defmt stubs: embassy-executor dev-dep has `defmt` feature, requiring these symbols.
// This binary uses panic_halt (no RTT/probe), so we provide no-op implementations.
#[no_mangle]
