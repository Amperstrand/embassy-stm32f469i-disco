//! Embassy DSI display test with panel auto-detection for STM32F469I-DISCO (portrait 480x800)
//!
//! Tests raw DSI/LTDC register access with NT35510/OTM8009A panel auto-detection.
//! Draws color bars (red/green/blue/checkerboard) via RGB565 framebuffer in SDRAM.
//! LED phase signaling shows init progress (green blink count = phase reached).
//!
//! Build:
//!   cargo build --release --target thumbv7em-none-eabihf \
//!     --manifest-path /home/ubuntu/src/embassy-stm32f469i-disco/Cargo.toml \
//!     --example embassy_display_bsp_minimal
//!
//! Flash (RTT debug — USB will NOT work):
//!   arm-none-eabi-objcopy -O binary target/thumbv7em-none-eabihf/release/embassy_display_bsp_minimal /tmp/embassy_display_bsp_minimal.bin
//!   st-flash --connect-under-reset write /tmp/embassy_display_bsp_minimal.bin 0x08000000
...
impl embedded_hal_02::blocking::delay::DelayMs<u32> for BusyDelay {
